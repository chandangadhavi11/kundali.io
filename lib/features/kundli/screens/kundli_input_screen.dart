...
class _KundliInputScreenState extends State<KundliInputScreen>
  ...
  void _initializeDefaultValues() {
    ...
    // Listen for manual name edits
    _nameController.addListener(_onNameFieldChanged);
  }

  /// Updates the name field with an auto-generated name based on selected date/time
  void _updateAutoGeneratedName() {
    ...
    final newName = '$dateStr, $timeStr';

    _lastAutoGeneratedName = newName;
    _nameController.text = newName;
  }

  /// Detects if user manually edited the name field
  void _onNameFieldChanged() {
    // If the current text differs from the last auto-generated name,
    // and the name field has focus (user is actively editing), mark as manually edited
    if (_nameFocusNode.hasFocus &&
        _nameController.text != _lastAutoGeneratedName) {
                        ...
                        child: Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _buildRecentProfilesSection(
                                context.watch<KundliProvider>(),
                              ),
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                Icon(Icons.bookmark_rounded, size: 14, color: _textMuted),
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: ListView.builder(
                ...
                padding: const EdgeInsets.symmetric(
                  horizontal: 20,
                ), // Add padding to match content alignment
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  if (isPrimary)
                    Icon(Icons.star_rounded, size: 14, color: _accentPrimary),
                ],
              ),
              // Bottom info
              Column(
  ...
  void _fillFromProfile(KundaliData profile) {
    setState(() {
      ...
      // Mark as manually edited since user selected a saved profile
      _nameManuallyEdited = true;
    });
  }
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(color: _successColor.withOpacity(0.3), width: 0.5),
        ),
        ...
        try {
          ...
          if (placemarks.isNotEmpty) {
            ...
            if (city.isNotEmpty && country.isNotEmpty) {
              ...
              name =
                  '$query (${location.latitude.toStringAsFixed(2)}°, ${location.longitude.toStringAsFixed(2)}°)';
            }
