...
class ModernPanchangScreen extends StatefulWidget {
  const ModernPanchangScreen({super.key});

  @override
  State<ModernPanchangScreen> createState() => _ModernPanchangScreenState();
}

class _ModernPanchangScreenState extends State<ModernPanchangScreen>
